import 'package:pkhex_flutter/PKHex.Core/Editing/PKM/PKM.dart';
...
{
    PKM _pk;
    static bool _showdownSetIVMarkings = true;
    static bool _showdownSetBehaviorNature;
    /// <summary>
    /// Setting which enables/disables automatic manipulation of PKM.MarkValue when importing from a IBattleTemplate.
    /// </summary>
    static bool get showdownSetIVMarkings =>  _showdownSetIVMarkings;

    static bool set showdownSetIVMarkings (bool incoming) {
      _showdownSetIVMarkings = incoming;
    }

    /// <summary>
    /// Setting which causes the PKM.StatNature to the PKM.Nature in Gen8+ formats.
    /// </summary>
    static bool get showdownSetBehaviorNature => _showdownSetBehaviorNature;
    ...
    static void SetNickname({PKM pk: _pk, String nick})
    {
        if (nick.length == 0)
        {
            pk.clearNickname();
